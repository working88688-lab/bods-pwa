<template>
  <div class="data-item" @click="onShow">
    <div class="data-img">
      ...
      >
        <img v-lazy="imageBase + itemInfo.comicVo.comicVo.chapterCover" />
      </div>
      <div
        class="cover-img"
        :style="{ width: coverWidth, 'padding-top': coverHeight }"
        v-else
      >
        <img v-lazy="imageBase + itemInfo.comicVo.comicVo.comicCover" />
      </div>
      <div class="data-status">
        {{ itemInfo.comicVo.comicVo.chapterOver ? '已完结' : '连载中' }}
      </div>
    </div>
    <div class="data-bottom">
      <div class="data-desc">
        <span class="data-name">{{ itemInfo.comicVo.comicVo.comicName }}</span>
      </div>
      <div class="data-update">
        <div v-if="itemInfo.comicVo.comicVo.chapterOver" class="view-num">
          <van-icon name="eye-o" />
          <span>{{
        ...
        <div v-else>
          {{ '更新至' + itemInfo.comicVo.comicVo.chapterCurrentSeq }}
        </div>
        <div class="tag-list">
          <span
            class="tag-item"
  ...
  methods: {
    ...
    onShow() {
      this.$router.push({
        ...
        query: {
          comicId:
            this.itemInfo.comicVo.comicId || this.itemInfo.comicVo.mediaId,
        },
      })
    },
  },
